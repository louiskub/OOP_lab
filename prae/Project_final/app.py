...
bg_pic = PhotoImage(file='/Users/sirima/Documents/Python/OOP/Project_final/waterpark.png')
bg2_pic = PhotoImage(file='/Users/sirima/Documents/Python/OOP/Project_final/water.png')
...
def login_page():
    ...
    def login():
        ...
        if email_l== ""  or password_l== "":
            ...
            set_user_id(response.json().get("mem_id"))
...
def home_member_page():
    ...
    service_button = ttk.Button(root, text="Services", command=service_member,width=width_botton,padding=pading_button)
    ...
    # logout_button = ttk.Button(root, text="Log out", command=log_out, width=width_botton, padding=pading_button, style=PRIMARY)
    # logout_button.grid(row=0, column=c+4)  # Adjust the column number as needed
...
def home_page():
    ...
    service_button = ttk.Button(root, text="Services", command=service,width=width_botton,padding=pading_button,style = PRIMARY)
    service_button.grid(row=0,column=c+1)
