...
def main():
    ...
    for i in range(len(booking)):
        # Labels
        line = ttk.Label(booking_frame, text="_____________________________________________________________________________________", font=("Helvetica", 15), background="#CDEDF4")
